// pages/cal-edit-custom/cal-edit-custom.js —— 自定义日历编辑页（兼具时间段+节次）
...
Page({
  ...
  onNext() {
    if (this.data.selectedCount === 0) {
      wx.showToast({ title: '请至少选择 1 格', icon: 'none' })
      return
    }
    wx.navigateTo({ url: '/pages/member-preset/member-preset?style=custom' })
  }
})
