...
function presetsFromApi(list) {
  ...
  (list || []).forEach((item) => {
    ...
    map[code] = {
      ...
      bigBreakAfter: Number(item.bigBreakAfter) || 0,
...
function applyCatalog(catalog) {
  ...
  return {
    ...
    presetTweaks: map,
    preset: firstCode,
    tweaks: { ...(map[firstCode] || { firstStart: '08:00', durationMin: 45, morningCount: 4, afternoonCount: 4, eveningCount: 0, breakMin: 10, bigBreakMin: 0, bigBreakAfter: 0, lunchStart: '12:00', lunchEnd: '13:30', hasLunch: false, lunchBlocked: true, dinnerStart: '18:00', dinnerEnd: '19:00', hasDinner: false, dinnerBlocked: true }) },
