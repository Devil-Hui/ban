...
```bash
git add new/package.json new/tsconfig.base.json new/.editorconfig new/.gitignore tools/verify-workspace.mjs apps/.gitkeep services/.gitkeep packages/.gitkeep
...
```bash
git add new/package-lock.json packages/contracts
...
```bash
git add .env.example docker-compose.yml infra/mysql/conf.d/charset.cnf tools/init-local-env.mjs tools/check-infrastructure.mjs
...
```bash
git add new/package-lock.json services/api
...
```bash
git add services/api/src/database services/api/test/database.integration.test.ts
...
```bash
git add services/api/src/redis services/api/src/health services/api/src/app.module.ts services/api/src/main.ts services/api/test/health.integration.test.ts
...
```bash
git add services/api/src/http services/api/src/main.ts services/api/test/error-response.test.ts
...
```bash
git add new/package.json tools/smoke-foundation.mjs docs/operations/local-foundation.md
